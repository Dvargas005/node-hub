...
const C = {
  en: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Member", front: 156, setup: 312, real: 100, realSetup: 200, per: "/mo", desc: "Your digital starter kit. Design and content essentials.", ft: false },
        { name: "Growth", front: 296, setup: 1092, real: 190, realSetup: 700, per: "/mo", desc: "Full creative power. Design, web, and content with priority.", ft: true },
        { name: "Pro", front: 515, setup: 1560, real: 330, realSetup: 1000, per: "/mo", desc: "Unlimited scale. All services, dedicated PM, fastest turnaround.", ft: false },
      ],
    },
  ...
  es: {
    ...
    pricing: {
      ...
      noteLink: "Dedicated Growth",
      plans: [
        { name: "Member", front: 156, setup: 312, real: 100, realSetup: 200, per: "/mes", desc: "Tu kit digital inicial. Diseño y contenido esencial.", ft: false },
        { name: "Growth", front: 296, setup: 1092, real: 190, realSetup: 700, per: "/mes", desc: "Poder creativo completo. Diseño, web y contenido con prioridad.", ft: true },
        { name: "Pro", front: 515, setup: 1560, real: 330, realSetup: 1000, per: "/mes", desc: "Escala ilimitada. Todos los servicios, PM dedicado, turnaround más rápido.", ft: false },
      ],
    },
